...
-- Seed dữ liệu người quản lý (Admin) và thiết lập tài khoản chuyển khoản VietQR động
SET IDENTITY_INSERT [dbo].[NguoiQuanLy] ON;
INSERT INTO [dbo].[NguoiQuanLy] ([MaQuanLy], [HoTen], [SDT], [Email], [TrangThai], [NgayTao], [SoTaiKhoan], [TenTaiKhoan], [MaNganHang])
VALUES (1, N'Nguyễn Văn Trị', '0987654321', 'manager@trosmart.com', N'Hoạt động', GETDATE(), '102876543210', N'NGUYEN VAN TRI', 1);
SET IDENTITY_INSERT [dbo].[NguoiQuanLy] OFF;
GO

-- Seed dữ liệu cơ sở nhà trọ
SET IDENTITY_INSERT [dbo].[CoSo] ON;
INSERT INTO [dbo].[CoSo] ([MaCoSo], [TenCoSo], [DiaChi], [MoTa], [LoaiHinh], [MaQuanLy], [Latitude], [Longitude], [DanhGia], [TrangThai], [NgayTao])
VALUES (1, N'Trọ Smart Quận Tân Phú', N'140 Lê Trọng Tấn, Tây Thạnh, Tân Phú, TP. HCM', N'Khu nhà trọ thông minh cao cấp gần trường HUIT', N'Nhà cao tầng', 1, 10.806, 106.629, 4.8, N'Hoạt động', GETDATE());
SET IDENTITY_INSERT [dbo].[CoSo] OFF;
GO

-- Seed các phòng trọ với công suất 2, 3 và 4 người để test share hóa đơn
SET IDENTITY_INSERT [dbo].[Phong] ON;
INSERT INTO [dbo].[Phong] ([MaPhong], [MaCoSo], [SoPhong], [Tang], [DienTich], [GiaThue], [SoNguoiToiDa], [TrangThai], [MoTa], [NgayTao]) VALUES
(1, 1, '101', 1, 25, 3500000, 2, N'Đang thuê', N'Phòng trọ tiện nghi tầng trệt - 2 người ở ghép', GETDATE()),
(2, 1, '202', 2, 30, 4500000, 3, N'Đang thuê', N'Phòng trọ view ban công thoáng mát - 3 người ở ghép', GETDATE()),
(3, 1, '303', 3, 35, 5500000, 4, N'Đang thuê', N'Phòng trọ diện tích lớn tầng 3 - 4 người ở ghép', GETDATE());
SET IDENTITY_INSERT [dbo].[Phong] OFF;
GO

-- Seed dữ liệu các khách thuê cùng phòng để mô phỏng ở ghép thực tế (share hóa đơn)
SET IDENTITY_INSERT [dbo].[KhachThue] ON;
INSERT INTO [dbo].[KhachThue] ([MaKhach], [HoTen], [SDT], [CCCD], [Email], [NgaySinh], [GioiTinh], [Dia ChiThuongTru], [NgayCapCCCD], [NoiCapCCCD], [TrangThai]) VALUES
-- Phòng 101 (2 người ở ghép)
(1, N'Trần Minh Hoàng', '0901234561', '079201012341', 'hoang101@trosmart.com', '2004-05-15', N'Nam', N'TP. Hồ Chí Minh', '2021-06-20', N'Cục Cảnh sát', N'Đang ở'),
(2, N'Lê Thảo Vy', '0901234562', '079201012342', 'vy101@trosmart.com', '2005-08-22', N'Nữ', N'Bình Dương', '2022-09-12', N'Cục Cảnh sát', N'Đang ở'),

-- Phòng 202 (3 người ở ghép)
(3, N'Phạm Anh Tuấn', '0901234563', '079201012343', 'tuan202@trosmart.com', '2003-02-10', N'Nam', N'Đồng Nai', '2020-04-18', N'Cục Cảnh sát', N'Đang ở'),
(4, N'Nguyễn Thị Kim Chi', '0901234564', '079201012344', 'chi202@trosmart.com', '2004-11-30', N'Nữ', N'Long An', '2021-12-05', N'Cục Cảnh sát', N'Đang ở'),
(5, N'Đỗ Hữu Nam', '0901234565', '079201012345', 'nam202@trosmart.com', '2003-07-14', N'Nam', N'Tiền Giang', '2020-08-25', N'Cục Cảnh sát', N'Đang ở'),

-- Phòng 303 (4 người ở ghép)
(6, N'Vũ Hoàng Long', '0901234566', '079201012346', 'long303@trosmart.com', '2004-03-05', N'Nam', N'Bà Rịa - Vũng Tàu', '2021-04-12', N'Cục Cảnh sát', N'Đang ở'),
(7, N'Bùi Minh Trí', '0901234567', '079201012347', 'tri303@trosmart.com', '2004-06-18', N'Nam', N'Tây Ninh', '2021-07-15', N'Cục Cảnh sát', N'Đang ở'),
(8, N'Đặng Phương Nam', '0901234568', '079201012348', 'dpnam303@trosmart.com', '2003-09-25', N'Nam', N'Cần Thơ', '2020-10-10', N'Cục Cảnh sát', N'Đang ở'),
(9, N'Ngô Gia Huy', '0901234569', '079201012349', 'huy303@trosmart.com', '2004-01-30', N'Nam', N'Vĩnh Long', '2021-02-28', N'Cục Cảnh sát', N'Đang ở');
SET IDENTITY_INSERT [dbo].[KhachThue] OFF;
GO

-- Seed hợp đồng thuê nhà tương ứng
SET IDENTITY_INSERT [dbo].[HopDongThue] ON;
INSERT INTO [dbo].[HopDongThue] ([MaHopDong], [MaPhong], [MaKhach], [NgayBatDau], [NgayKetThuc], [TienCoc], [TrangThai], [NgayTao], [ChuKy]) VALUES
(1, 1, 1, '2025-09-01', '2026-09-01', 3500000, N'Đang hoạt động', GETDATE(), N'12 tháng'),
(2, 2, 3, '2025-09-01', '2026-09-01', 4500000, N'Đang hoạt động', GETDATE(), N'12 tháng'),
(3, 3, 6, '2025-09-01', '2026-09-01', 5500000, N'Đang hoạt động', GETDATE(), N'12 tháng');
SET IDENTITY_INSERT [dbo].[HopDongThue] OFF;
GO

-- Seed tài khoản đăng nhập để tiện lợi kiểm thử giao diện của Admin & User
SET IDENTITY_INSERT [dbo].[TaiKhoan] ON;
INSERT INTO [dbo].[TaiKhoan] ([MaTaiKhoan], [TenDangNhap], [MatKhau], [VaiTro], [MaQuanLy], [MaKhach], [TrangThai], [NgayTao]) VALUES
-- Tài khoản quản lý
(1, 'admin', 'admin123', N'Admin', 1, NULL, N'Hoạt động', GETDATE()),
-- Tài khoản đại diện khách thuê phòng 101 (2 người share)
(2, 'hoang101', 'user123', N'KhachThue', NULL, 1, N'Hoạt động', GETDATE()),
-- Tài khoản đại diện khách thuê phòng 202 (3 người share)
(3, 'tuan202', 'user123', N'KhachThue', NULL, 3, N'Hoạt động', GETDATE()),
-- Tài khoản đại diện khách thuê phòng 303 (4 người share)
(4, 'long303', 'user123', N'KhachThue', NULL, 6, N'Hoạt động', GETDATE());
SET IDENTITY_INSERT [dbo].[TaiKhoan] OFF;
GO

-- Seed Hóa Đơn tháng 05/2026 cho 3 phòng trọ trên (gồm đầy đủ Phí phát sinh động và Dịch vụ phòng bổ sung)
SET IDENTITY_INSERT [dbo].[HoaDon] ON;
INSERT INTO [dbo].[HoaDon] ([MaHoaDon], [MaPhong], [MaKhach], [Thang], [Nam], [TienPhong], [ChiSoDienCu], [ChiSoDienMoi], [DonGiaDien], [ChiSoNuocCu], [ChiSoNuocMoi], [DonGiaNuoc], [TienDichVu], [MoTaDichVu], [PhuPhi], [MoTaPhuPhi], [TongTien], [TrangThai], [NgayLap], [HanThanhToan], [NgayThanhToan]) VALUES
-- Hóa đơn phòng 101: 2 người share. Tổng tiền = 3,500,000 (phòng) + 525,000 (điện: 150kwh * 3500) + 240,000 (nước: 12m3 * 20000) + 100,000 (dịch vụ) + 150,000 (phụ phí) = 4,515,000 đ
(1, 1, 1, 5, 2026, 3500000, 1000, 1150, 3500, 100, 112, 20000, 100000, N'Wifi (50.000đ), Rác (50.000đ)', 150000, N'Thay bóng đèn hành lang (150.000đ)', 4515000, N'Chờ thanh toán', '2026-05-01', '2026-05-15', NULL),

-- Hóa đơn phòng 202: 3 người share. Tổng tiền = 4,500,000 (phòng) + 700,000 (điện: 200kwh * 3500) + 400,000 (nước: 20m3 * 20000) + 150,000 (dịch vụ) + 300,000 (phụ phí) = 6,050,000 đ
(2, 2, 3, 5, 2026, 4500000, 2000, 2200, 3500, 200, 220, 20000, 150000, N'Wifi (50.000đ), Vệ sinh chung (100.000đ)', 300000, N'Bảo trì ổ khóa vân tay (300.000đ)', 6050000, N'Chờ thanh toán', '2026-05-01', '2026-05-15', NULL),

-- Hóa đơn phòng 303: 4 người share. Tổng tiền = 5,500,000 (phòng) + 1,050,000 (điện: 300kwh * 3500) + 600,000 (nước: 30m3 * 20000) + 200,000 (dịch vụ) + 400,000 (phụ phí) = 7,750,000 đ
(3, 3, 6, 5, 2026, 5500000, 3000, 3300, 3500, 300, 330, 20000, 200000, N'Wifi (100.000đ), Rác sinh hoạt (100.000đ)', 400000, N'Lắp đặt thêm kệ giày dép gỗ (400.000đ)', 7750000, N'Chờ thanh toán', '2026-05-01', '2026-05-15', NULL);
SET IDENTITY_INSERT [dbo].[HoaDon] OFF;
GO

-- Seed tiện ích mẫu
SET IDENTITY_INSERT [dbo].[TienIch] ON;
INSERT INTO [dbo].[TienIch] ([MaTienIch], [TenTienIch]) VALUES
(1, N'Wifi tốc độ cao'),
(2, N'Khóa vân tay bảo mật'),
(3, N'Khu để xe miễn phí'),
(4, N'Camera an ninh 24/7');
SET IDENTITY_INSERT [dbo].[TienIch] OFF;
GO

-- Khớp nối tiện ích với các phòng để hiển thị hoàn hảo trên UI
INSERT INTO [dbo].[Phong_TienIch] ([MaPhong], [MaTienIch]) VALUES
(1, 1), (1, 2),
(2, 1), (2, 2), (2, 3),
(3, 1), (3, 2), (3, 3), (3, 4);
GO

-- Kiểm tra kết quả gán hóa đơn của phòng và tài khoản khách thuê
SELECT H.MaHoaDon, P.SoPhong, K.HoTen AS TenKhachDaiDien, H.TongTien, H.TrangThai 
FROM [dbo].[HoaDon] H
JOIN [dbo].[Phong] P ON H.MaPhong = P.MaPhong
JOIN [dbo].[KhachThue] K ON H.MaKhach = K.MaKhach
GO
