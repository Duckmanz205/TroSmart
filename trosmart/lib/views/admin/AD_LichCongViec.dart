    ...
    return Container(
      ...
      decoration: const BoxDecoration(
        gradient: LinearGradient(
          colors: [Color(0xCC6A3092), Color(0xFFA452B1)],
        ),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget _buildSectionHeader(String title, String subtitle) {
    return Row(
      ...
      children: [
        ...
        Text(
          subtitle,
          style: const TextStyle(color: Color(0xCC6A3092), fontSize: 12),
        ),
      ],
    );
  }
  ...
  Widget _buildCalendarRow(List<String> days, {List<int>? highlights}) {
    return Padding(
      ...
      child: Row(
        ...
        children: days.map((d) {
          bool isHighlighted =
              highlights?.contains(int.tryParse(d) ?? -1) ?? false;
          return Container(
            ...
            child: Text(
              d,
              style: TextStyle(
                color: isHighlighted ? const Color(0xFF2DDCB1) : Colors.white70,
                fontSize: 12,
              ),
            ),
          );
